...
async mainfunction(comName,formPath)
{
        ...
        await this.updateHTMLFile(formPath).then((HTMLfile)=>
            ...
            }else
            {
                ...
                var  arr_var = [this.comRec[1], this.comRec[2], this.comRec[3],this.comRec[4],this.comRec[5], this.comRec[6]];
                var arr_val = ['com_value', 'type_value', 'prp_value','addrs_value','other_value','xxxxxxxx']
